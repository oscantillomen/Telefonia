      ...
      <br>
        <div id="informacion" class="container hide">
          ...
          <div class="inputs">
            ...
            <input id="txtpunto_de_voz" type="text" placeholder="Número de Directorio" class="centrado large-2 solonum" required>
            ...
            <input id="txttipo_terminal" type="text" placeholder="Tipo de Terminal" class="centrado columns large-3 solonum" required>
          </div>
          <div class="inputs">
            <strong>Apellido de Directorio</strong><br>
            <input id="txtapellido_directorio" type="text" placeholder="Apellido Directorio" class="centrado columns large-3 solonum" required>
          ...
          <div class="inputs">
            ...
            <input id="txtnombre_directorio" type="text" placeholder="Nombre Directorio" class="centrado columns large-3 solonum" required>
            ...
            <input id="txtcubiculo" type="text" placeholder="Cubículo" class="centrado columns large-3 solonum" required> 
          </div>
          <div class="inputs">
