                  ...
                  success:function(datos) {
                    ...
                    if($('#txtconEditar').val()!=''){
                      ...
                      for (var i =1;i<=saltos;i++) {
                        ...
                        cargar_combo_regletas(datos.reg[i].registro,$('#cbxRG_in'+i),datos.reg[i].entrada,0);
                        cargar_combo_regletas(datos.reg[i].registro,$('#cbxRG_out'+i),datos.reg[i].salida,0);
        ...
        success:function(datos) {
          for (var i = 0; i < datos.total; i++) {
            if(campo3!=datos.puertos[i].puerto){
              ...
              /*alert('seleccionado '+campo3+' - '+datos.puertos[i].puerto); */ 
            };
          };
        },
        error:function() {
